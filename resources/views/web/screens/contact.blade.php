    ...
    <section class="py-16 bg-white">
        <div class="container">
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-10">
                <div>
                    <h3 class="text-3xl text-orange-600 font-bold ps-5 border-s-4 border-s-orange-600 mb-5">
                        Enquiry Now:
                    </h3>
                ...
                <div>
                    ...
                    <div class="text-lg">
                        <div class="flex gap-3 items-center py-5 border-b-2">
                            <i class="bi bi-phone text-orange-600 text-3xl"></i>
                            <div>
                                <div class="font-bold">
                                    Contact No.:
                                </div>
                        ...
                        <div class="flex gap-3 items-center py-5 border-b-2">
                            <i class="bi bi-envelope text-orange-600 text-3xl"></i>
                            <div>
                                <div class="font-bold">
                                    Email Address:
                                </div>
                        ...
                        <div class="flex gap-3 py-5">
                            <i class="bi bi-geo-alt text-orange-600 text-3xl"></i>
                            <address>
